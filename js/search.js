  ...
  */
  ...
  function getCardSearchText(card) {
    ...
    /*
      ...
      searchable string for better performance.
    */
    ...
    */
    ...
    /*
      Fallback:
      Search only meaningful title and description
      text rather than buttons or other card UI.
    */
  ...
  function matchesSearch(
    ...
    /*
      ...
      will match a card if all words
      exist somewhere in its title or description.
    */
  ...
  function runSearch() {
    ...
    /*
      ...
      to update the documentary count
      and other homepage UI.
    */
  ...
  function handleDocumentariesRendered() {
    ...
    /*
      ...
      apply the query to the newly created cards.
    */
