...
function resolveSiteConfig() {
  ...
  */
  ...
  warn(
    "Production SITE_URL was not found. Using a local URL."
  );
...
function normalizeDate(value) {
  ...
  /*
    The YAML parser may convert a date
    into a Date object.
  */
  ...
  /*
    Ambiguous dates are not accepted.
...
function getContentFiles() {
  ...
  if (
    ...
    warn(
      "The content/ directory was not found. No documentary will be published."
    );
...
function readDocumentary(filePath) {
  ...
  if (!plainBody) {
    ...
    fail(
      `${sourceFile}: documentary body is empty.`
    );
  }
  ...
  if (!title) {
    ...
    fail(
      `${sourceFile}: title was not found.`
    );
  }
  ...
  if (
    ...
    fail(
      `${sourceFile}: a valid date is required for a published documentary. ` +
      `Format: YYYY-MM-DD`
    );
  }
  ...
  if (
    ...
    fail(
      `${sourceFile}: description was not found.`
    );
  }
  ...
  /*
    Draft documentary images are not mandatory.

    Published documentary:
    exactly 4 required valid image files.
...
function createArticleImageFigure(
  ...
  const caption =
    customCaption ||
    `Representative image ${toEnglishNumber(imageNumber)} from the ${documentary.title} documentary`;
...
>
  ...
  <div class="article-image-frame">
    ...
    <img
      ...
      alt="${escapeHTML(documentary.title)} — image ${toEnglishNumber(imageNumber)}"
      width="1200"
      height="675"
      loading="lazy"
      decoding="async"
  ...
  <figcaption>
    <strong>
      Image ${toEnglishNumber(imageNumber)}:
    </strong>
...
<li class="toc-empty">
  <span>
    This documentary does not contain separate section headings
  </span>
</li>
`.trim();
  }
...
<figure class="documentary-cover">
  ...
  <div class="video-preview">
    ...
    <img
      ...
      alt="YouTube thumbnail for the ${escapeHTML(documentary.title)} documentary"
      width="1280"
      height="720"
      loading="eager"
      decoding="async"
    ...
    <a
      ...
      aria-label="Watch ${escapeHTML(documentary.title)} on YouTube"
    >
  ...
  <figcaption>
    Published SalimGPT documentary video.
...
<figure class="documentary-cover">
  ...
  <div class="documentary-cover-frame">
    ...
    <img
      ...
      alt="Main image for the ${escapeHTML(documentary.title)} documentary"
      width="1200"
      height="675"
      loading="eager"
      decoding="async"
...
<div class="documentary-data-empty">
  <strong>
    More documentaries will appear here as they are published
  </strong>
</div>
`.trim();
  }
...
>
  ...
  <img
    ...
    alt="Thumbnail for the ${escapeHTML(item.title)} documentary"
    width="640"
    height="360"
    loading="lazy"
    decoding="async"
...
function loadDocumentaryTemplate() {
  ...
  if (
    ...
    fail(
      "templates/documentary.html was not found."
    );
  }
  ...
  if (
    ...
    fail(
      "templates/documentary.html is empty."
    );
  }
...
function buildDocumentaryPage(
  ...
  const replacements = {
    ...
    /*
      DATE_BN is retained for backward compatibility
      with the existing documentary template.
      Its value is now formatted in English.
    */
...
function build() {
  ...
  /*
    IMPORTANT:
    Validate the source files FIRST.

    If a documentary or image is invalid,
    the build should fail before replacing
    the previously deployed site.
  */
